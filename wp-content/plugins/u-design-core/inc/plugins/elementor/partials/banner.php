			...
			$repeater->start_controls_tab(
				...
				$repeater->add_control(
					...
					array(
						...
						'selectors'   => array(
							'.elementor-element-{{ID}} {{CURRENT_ITEM}} img, .elementor-element-{{ID}} {{CURRENT_ITEM}}.divider-wrap, .elementor-element-{{ID}} {{CURRENT_ITEM}} .divider, .elementor-element-{{ID}} {{CURRENT_ITEM}}.btn' => 'border-radius: {{SIZE}}{{UNIT}};',
						),
					)
				);
